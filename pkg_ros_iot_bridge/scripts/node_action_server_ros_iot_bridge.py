...
called when the Action Server receives a Cancel Request.
	...
	self._submission_sheet_url = param_config_pyiot['google_apps']['submission_spread_sheet']
    ...
    def mqtt_sub_callback(self, client, userdata, message):
        '''This is a callback function for MQTT Subscriptions
           ...
           Parameters :
           a)client = This is the client which has sent the goal
           b)userdata = The information about the action client
           c)message = The message which is being published on MQTT
        '''
    ...
    def on_goal(self, goal_handle):
        '''This function will be called when Action Server receives a Goal
           ...
           Parameters :
           a)goal_handle = The goal sent by the action client will reside in this
        '''
    ...
    def process_goal_1(self, goal_handle):
        ...
        if goal.protocol == "google_apps":
            ...
            iot.to_spreadsheet(self._submission_sheet_url, data)
            result.flag_success = True
